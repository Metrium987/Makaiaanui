...
export default function Settings() {
  const [workspaceName, setWorkspaceName] = useState('Pacific Games Tahiti 2027');
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input type="text" defaultValue="portal.tahiti2027.com" className="w-full px-4 py-2 border border-slate-200 rounded-md focus:ring-1 focus:ring-indigo-500 focus:outline-none text-sm text-slate-500 bg-slate-50 cursor-not-allowed" disabled />
                  </div>
                </div>
              </div>
