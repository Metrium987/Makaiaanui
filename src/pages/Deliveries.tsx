...
export default function Deliveries() {
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      await addDelivery({ site, status, scheduled_time: scheduledTime ? new Date(scheduledTime).toISOString() : new Date().toISOString(), detail, group_id: selectedGroupId || undefined });
  ...
  const resetForm = () => { setSite('Main Stadium'); setStatus('PENDING'); setScheduledTime(''); setDetail(''); setSelectedGroupId(''); };
