    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 selection:bg-indigo-100 selection:text-indigo-900">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-slate-500">
          {isForgotPassword
            ? t('login.forgotPasswordSubtitle', 'Enter your email to receive a reset link.')
          ...
          {isForgotPassword ? (
            <form className="space-y-6" onSubmit={handleForgotPassword}>
              ...
              <div>
                ...
                >
                  {loading ? t('login.sendingReset', 'Sending...') : t('login.sendResetLink', 'Send Reset Link')}
              ...
              <div className="text-center">
                <button
                  ...
                  className="text-xs font-bold text-indigo-600 hover:text-indigo-500 transition-colors flex items-center gap-1 mx-auto"
                >
